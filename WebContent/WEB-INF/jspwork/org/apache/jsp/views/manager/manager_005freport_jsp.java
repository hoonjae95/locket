 ...
 * Generated at: 2020-10-29 07:42:45 UTC
...
public final class manager_005freport_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/WEB-INF/views/common/ad.jsp", Long.valueOf(1603870555582L));
    _jspx_dependants.put("/resources/globalVariable.jsp", Long.valueOf(1602818384000L));
    _jspx_dependants.put("/WEB-INF/views/common/header.jsp", Long.valueOf(1603870555594L));
    _jspx_dependants.put("/WEB-INF/views/common/nav.jsp", Long.valueOf(1603955660219L));
    _jspx_dependants.put("/WEB-INF/views/common/footer.jsp", Long.valueOf(1603870555589L));
    _jspx_dependants.put("/WEB-INF/views/common/tom.jsp", Long.valueOf(1603870555614L));
  }
 ...
 if(loginMember != null && loginMember.getRankCode() == 99) { 
      ...
      out.write("\t\t\t\t\t\t<li onclick=\"location.href='");
      out.print( context );
      out.write("/groupWriteForm.do'\">공동구매 물품등록</li> \r\n");
      out.write("\t\t\t\t\t\t<li onclick=\"location.href='");
      out.print( context );
      out.write("/buy_list.do'\">입금 확인 조회</li> \r\n");
      out.write("\t\t\t\t\t\t");
 } 
      out.write("\r\n");
      out.write("\t\t\t\t\t</ul>\r\n");
 ...
 if(loginMember != null && loginMember.getRankCode() == 99) { 
      ...
      out.write("\t\t\t\t<p id=\"title\">신고 관리</p>\r\n");
      out.write("\t\t\t\t<br>\r\n");
      out.write("\t\t\t\t<hr>\r\n");
      out.write("\t\t\t\t<br><br>\r\n");
      out.write("\t\t\t\t<div id=\"report-area-drop\">\r\n");
      out.write("\t\t\t\t\t<select id=\"report_category\">\r\n");
      out.write("\t\t\t\t\t\t<option value=\"댓글신고\" class=\"drop\">댓글 신고</option>\r\n");
      out.write("\t\t\t\t\t\t<option value=\"댓글신고\" class=\"drop\">게시글 신고</option>\r\n");
      out.write("\t\t\t\t\t\t<option value=\"댓글신고\" class=\"drop\">상품 신고</option>\r\n");
      out.write("\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<br>\r\n");
      out.write("\t\t\t\t<div id=\"report-area-table\">\r\n");
      out.write("\t\t\t\t\t<table border=\"1\" style=\"width: 980px;\" class=\"report-list\">\r\n");
      out.write("\t\t\t\t\t\t<tr id=\"report-head\">\r\n");
      out.write("\t\t\t\t\t\t\t<td class=\"report-check\"><input type=\"checkbox\" value=\"전체선택\"></td>\r\n");
      out.write("\t\t\t\t\t\t\t<th>회원 명</th>\r\n");
      out.write("\t\t\t\t\t\t\t<th>회원등급</th>\r\n");
      out.write("\t\t\t\t\t\t\t<th>회원ID</th>\r\n");
      out.write("\t\t\t\t\t\t\t<th>신고 사유</th>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<td class=\"report-check\"><input type=\"checkbox\"></td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>토마토</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>종이비행기</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>tomatoma</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>못생김</td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<td class=\"report-check\"><input type=\"checkbox\"></td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>감자</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>로켓</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>kangwondo</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>더 못생김</td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<td class=\"report-check\"><input type=\"checkbox\"></td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>고구마</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>비행기</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>daldalhae</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>네고왕</td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<td class=\"report-check\"><input type=\"checkbox\"></td>\r\n");
      ...
      out.write("\t\t\t\t\t<input type=\"submit\" value=\"회원 정지\" onclick=\"suspend();\">\r\n");
      out.write("\t\t\t\t\t<script>\r\n");
      out.write("\t\t\t\t\t\tfunction suspend(){\r\n");
      out.write("\t\t\t\t\t\t\tvar susp = confirm(\"해당 회원을 *정지*시키겠습니까?\")\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\tif(susp){\r\n");
      out.write("\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t} else{\r\n");
      ...
      out.write("\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t</script>\r\n");
      out.write("\t\t\t\t\t<input type=\"submit\" value=\"회원 제명\" onclick=\"expulsion();\">\r\n");
      out.write("\t\t\t\t\t<script>\r\n");
      out.write("\t\t\t\t\t\tfunction expulsion(){\r\n");
      out.write("\t\t\t\t\t\t\tvar expel = confirm(\"해당 회원을 *제명*하시겠습니까??\")\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\tif(expel){\r\n");
      out.write("\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t} else{\r\n");
