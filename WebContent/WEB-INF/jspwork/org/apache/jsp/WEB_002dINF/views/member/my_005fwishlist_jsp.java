 ...
 * Generated at: 2020-12-04 14:14:46 UTC
...
public final class my_005fwishlist_jsp extends org.apache.jasper.runtime.HttpJspBase
...
// 	System.out.println(pi.getEndPage());
	...
	String context = request.getContextPath();
      ...
      out.write("<link rel=\"stylesheet\" type=\"text/css\" href=\"");
      out.print( context );
      out.write("/resources/css/my_wishlist.css\">\r\n");
 ...
 if(wList.isEmpty() || wfList.isEmpty()) { 
      ...
      out.write("\t\t\t\t\t\t\t<label class=\"glyphicon glyphicon-alert\"> </label>\r\n");
      out.write("\t\t\t\t\t\t\t<label>찜한 상품이 없습니다.</label>\r\n");
      out.write("\t\t\t\t\t\t\t<br><br><br>\r\n");
      out.write("\t\t\t\t\t\t\t<label id=\"goRegister\" class=\"glyphicon glyphicon-hand-right\"></label>\r\n");
      out.write("\t\t\t\t\t\t\t<button id=\"goRegister\" onclick=\"location.href='");
      out.print( context );
      out.write("/list.pro'\">상품 구경하러 가기!</button>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t");
 } else { 
      out.write("\r\n");
 ...
 if(!wList.isEmpty()) { 
      ...
      out.print( context );
      out.write("/myWishlist.do?currentPage=1'\">&lt;&lt;</button>\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t<!-- 이전 페이지로 -->\r\n");
      out.write("\t\t\t\t\t\t<button onclick=\"location.href='");
      out.print( context );
      out.write("/myWishlist.do?currentPage=");
 ...
 if(p == currentPage) { 
      ...
      out.write("\t\t\tif(confirm('해당 상품을 목록에서 삭제하시겠습니까?')) {\r\n");
      out.write("\t\t\t\tvar pId = e.value;\t\t\r\n");
      out.write("\t\t\t\tlocation.href='deleteWishlist.do?pId=' + pId;\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\t</script>\r\n");
      out.write("\t\r\n");
