 ...
 * Generated at: 2020-11-08 13:50:20 UTC
...
public final class message_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	int endPage = pi.getEndPage();
      ...
      out.write("<link rel=\"stylesheet\" type=\"text/css\" href=\"");
      out.print( context );
      out.write("/resources/css/message_list.css\">\r\n");
      out.write("\r\n");
      out.write("</head>\r\n");
      out.write("<body>\r\n");
 ...
 if(loginMember != null && loginMember.getRankCode() == 99) { 
      ...
      out.write("\t\t\t\t\t<input type =\"button\" id =\"sendmessage\" value =\"쪽지 보내기\" onclick = \"send();\">\r\n");
      out.write("\t\t\t\t\t<form action=\"");
      out.print( context );
      out.write("/deleteMessage.do\" method=\"post\" onsubmit=\"return deleteDeli(this);\">\r\n");
      out.write("\t\t\t\t\t\t<input type =\"submit\" id =\"delete\" value =\"삭제\">\r\n");
      out.write("\t\t\t\t\t</form>\r\n");
      out.write("\t\t\t\t<table class = \"board_list\">\r\n");
      out.write("\t\t\t\t\t<thead>\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<th><input type=\"checkbox\" name=\"selectAll\" id=\"all\"></th>\r\n");
 ...
 if(messageList.isEmpty()){ 
      out.write("\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td colspan=\"4\">받은 메세지가 없습니다.</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t");
 } else { 
      out.write("\r\n");
 ...
 for(Message m : messageList) { 
      ...
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"checkbox\" name=\"selmessage\" onclick=\"selectOne();\" value='");
      out.print( m.getMessage_Num() );
      out.write("'>\r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t<td>");
      out.print( m.getSendId() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t<td name=\"td\">");
      out.print( m.getMContent() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t<td>");
      out.print( m.getSendDate() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t");
 } 
      ...
      out.write("/message.do?currentPage=1'\" align=\"center\"> &lt;&lt;</button>\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t<!-- 이전 페이지로 -->\r\n");
      out.write("\t\t\t<button onclick=\"location.href='");
      out.print( request.getContextPath() );
      out.write("/message.do?currentPage=");
 ...
 if(p == currentPage) { 
      ...
      out.write("\t\t\t    \t  window.open('messageSendForm.do', 'messageSend' , 'width=600, height=400'); \r\n");
      out.write("\t\t\t      }\r\n");
      out.write("\t\t\t      \r\n");
      out.write("\t\t\t      \r\n");
      out.write("\t\t\t      \r\n");
      ...
      out.write("\t\t\t\t\tvar selmessage = document.getElementsByName(\"selmessage\");\r\n");
      out.write("\t\t\t\t\t\r\n");
      ...
      out.write("\t\t\t\t\t\t\tfor(var i = 0; i < selmessage.length; i++){\r\n");
      out.write("\t\t\t\t\t\t\t\tselmessage[i].checked = true;\r\n");
      out.write("\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t} else{\r\n");
      out.write("\t\t\t\t\t\t\tfor(var i = 0; i < selmessage.length; i++){\r\n");
      out.write("\t\t\t\t\t\t\t\tselmessage[i].checked = false;\r\n");
      out.write("\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t} \r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\r\n");
      ...
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\tfor(var i = 0; i < selmessage.length; i++){\r\n");
      out.write("\t\t\t\t\t\t\tif(selmessage[i].checked){\r\n");
      out.write("\t\t\t\t\t\t\t\tcount++;\r\n");
      out.write("\t\t\t\t\t\t\t} \r\n");
      out.write("\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\tif(count != selmessage.length){\r\n");
      ...
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t      \t$(function(){\r\n");
      out.write("\t\t\t      \t\t$('.board_list td[name=td]').click(function(){\r\n");
      out.write("\t\t\t      \t\t\tvar num = $(this).parent().first().find('input').val();\r\n");
      out.write("\t\t\t\t\t\t\tlocation.href='");
      out.print( request.getContextPath() );
      out.write("/messageDetail.do?num=' + num;\r\n");
      out.write("\t\t\t      \t\t});\r\n");
      out.write("\t\t\t      \t});\r\n");
      out.write("\t\t\t      \t// 메세지 삭제\r\n");
      out.write("\t\t\t      \tfunction deleteDeli(form){\r\n");
      out.write("\t\t\t\t\t\tvar checking = document.getElementsByName(\"selmessage\");\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\tvar count = 0;\r\n");
      ...
      out.write("\t\t\t\t\t\t\talert('삭제할 주소를 선택해주세요.');\r\n");
      out.write("\t\t\t\t\t\t} else {\r\n");
      ...
      out.write("\t\t\t \t\t\t\t\t\tdata.setAttribute(\"value\", arr[i]);\r\n");
      out.write("\t\t\t \t\t\t\t\t\tdata.setAttribute(\"name\", \"selmessage\");\r\n");
