 ...
 * Generated at: 2020-11-08 13:47:14 UTC
...
public final class my_005fdelivery_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes.add("shipping_address.model.vo.Shipping_address");
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	String context = request.getContextPath();
      ...
      out.write("<link rel=\"stylesheet\" type=\"text/css\" href=\"");
      out.print( context );
      out.write("/resources/css/my_delivery.css\">\r\n");
 ...
 if(loginMember != null && loginMember.getRankCode() == 99) { 
      ...
      out.write("\t\t\t\t<br>\t\t\t\r\n");
      out.write("\t\t\t\t<h1>나의 배송지</h1>\r\n");
      out.write("\t\t\t\t");
 if(loginMember != null) { 
      out.write("\r\n");
      out.write("\t\t\t\t<input type=\"submit\" id=\"obj\" value=\"추가하기\">\r\n");
      out.write("\t\t\t\t");
 } 
      out.write("\r\n");
      out.write("\t\t\t\t<div class=\"delivery_list_wrap\">\r\n");
      out.write("\t\t\t\t\t<table class=\"delivery_list\" id=\"dTable\">\r\n");
      out.write("\t\t\t\t\t\t<thead>\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<th width=\"50px\"><input type=\"checkbox\" id=\"allCheck\" onclick=\"allChk(this);\"/></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t<th width=\"100px\">받는 분</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t<th width=\"200px\">주소</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t<th width=\"130px\">연락처</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t<th width=\"100px\">배송지 명</th>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t</thead>\r\n");
      out.write("\t\t\t\t\t\t<tbody>\r\n");
      out.write("\t\t\t\t\t\t");
 if(list.isEmpty()) { 
      out.write("\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<td colspan=\"5\">저장된 배송지가 없습니다.</td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t");
 } else { 
      out.write("\r\n");
 ...
 for(Shipping_address s : list) { 
      ...
      out.write("\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"checkbox\" name=\"RowCheck\" id=\"rcheck\" value=\"");
      out.print( s.getAddress_num() );
      out.write("\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td>");
      out.print( s.getReceiver() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td>");
      out.print( s.getAdderss() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td>");
      out.print( s.getPhone() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td>");
      out.print( s.getAddress_name() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t");
 } 
 ...
 if(!list.isEmpty()) { 
      ...
      out.write("\t\t\t\t\t<form action=\"");
      out.print( context );
      out.write("/deleteSA.do\" method=\"post\" onsubmit=\"return deleteDeli(this);\">\r\n");
      out.write("\t\t\t\t\t\t<input type=\"submit\" id=\"deleteBtn\" value=\"삭제하기\">\t\t\r\n");
      out.write("\t\t\t\t\t</form>\r\n");
      out.write("\t\t\t\t");
 } 
      out.write("\r\n");
      ...
      out.write("\t\r\n");
      out.write("\t<script>\r\n");
      out.write("\t\tdocument.getElementById(\"obj\").onclick = function() {\r\n");
      out.write("\t\t\topenWindow(function(win) {\r\n");
      out.write("\t\t\t\tlocation.href = \"");
      out.print( context );
      out.write("/deliveryList.do\";\r\n");
      out.write("\t\t\t});\r\n");
      out.write("\t\t};\r\n");
      out.write("\r\n");
      out.write("\t\tvar openWindow = function(closeCallback) {\r\n");
      out.write("\t\t    var win = window.open('updateDeliveryForm.do', 'updateDeliveryForm', 'width=500, height=450');\r\n");
      out.write("\t\t    var interval = window.setInterval(function() {\r\n");
      out.write("\t\t        try {\r\n");
      out.write("\t\t            if (win == null || win.closed) {\r\n");
      out.write("\t\t                window.clearInterval(interval);\r\n");
      ...
      out.write("\t\t\tvar checking = document.getElementsByName(\"RowCheck\");\r\n");
      out.write("\t\t\t\r\n");
      ...
      out.write(" \t\t\t\t\t\tdata.setAttribute(\"name\", \"RowCheck\");\r\n");
