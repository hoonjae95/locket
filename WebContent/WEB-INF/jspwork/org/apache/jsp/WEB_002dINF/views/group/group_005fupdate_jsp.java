 ...
 * Generated at: 2020-11-06 07:30:21 UTC
...
public final class group_005fupdate_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	String context = request.getContextPath();
      ...
      out.write("<link rel=\"stylesheet\" type=\"text/css\" href=\"");
      out.print( context );
      out.write("/resources/css/group_write.css\">\r\n");
      out.write("\r\n");
      out.write("</head>\r\n");
      out.write("<body>\r\n");
 ...
 if(loginMember != null && loginMember.getRankCode() == 99) { 
      ...
      out.write("\t\t\t<br>\r\n");
      out.write("\t\t\t<h1>공동구매 물품등록</h1>\t\r\n");
      out.write("\t\t\t\t<form id=\"form1\" action=\"groupUpdate.do\" method=\"post\" encType=\"multipart/form-data\">\r\n");
      out.write("\t\t\t\t\t<button id=\"obj\" type=\"button\" onclick=\"groupUpdate();\">등록</button>\r\n");
      out.write("\t\t\t\t\t<br><br>\r\n");
      out.write("\t\t\t\t\t<input type=\"hidden\" name=\"bnum\" value=\"");
      out.print( g.getGroupNum() );
      out.write("\">\t\r\n");
      out.write("\t\t\t\t\t<input type=\"text\" id=\"title\" name=\"title\" placeholder=\"제목을 입력하세요.\" value=\"");
      out.print( g.getGroupTitle() );
      out.write("\">\r\n");
      out.write("\t\t\t\t\t<br><br>\r\n");
      out.write("\t\t\t\t\t<div id=\"fileField\">\r\n");
      out.write("\t\t\t\t\t\t<div id=\"filetext\" style=\"height: ");
      out.print( 28 + flist.size() * 26 );
      out.write("px;\">첨부파일</div>\r\n");
      out.write("\t\t\t\t\t\t");
 for(int i = 0; i < flist.size(); i++) { 
      out.write("\r\n");
      out.write("\t\t\t\t\t\t<div id=\"setFile-");
      out.print( i );
      out.write("\" style=\"display: flex;\">\r\n");
      out.write("\t\t\t\t\t\t\t<input class=\"exfile\" name=\"setFile_");
      out.print( i );
      out.write("\" type=\"hidden\" value=\"");
      out.print( flist.get(i).getFileId() );
      out.write("\">\r\n");
      out.write("\t\t\t\t\t\t\t<a href=\"");
      out.print( context );
      ...
      out.write("\t\t\t\t\t\t\t\t<input type=\"text\" style=\"display: inline-block; float: left;\" onchange=\"changeFile(this);\" readonly value=\"");
      out.print( flist.get(i).getOriginName() );
      out.write("\">\r\n");
      out.write("\t\t\t\t\t\t\t</a>\r\n");
      out.write("\t\t\t\t\t\t\t<input name=\"fileDel\" type=\"button\" value=\"삭제\" style=\"display: inline-block; float: left;\" onclick=\"delFile('setFile-");
      out.print( i );
      out.write("');\">\t\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t");
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t<div id=\"setFile\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<input type=\"file\" id=\"file\" name=\"file\" onchange=\"changeFile(this);\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<input type=\"date\" name=\"startdate\" id=\"startdate\" value=\"");
      out.print( g.getStartDate() );
      out.write("\"> \r\n");
      out.write("\t\t\t\t\t\t\t\t~\r\n");
      out.write("\t\t\t\t\t\t\t\t<input type=\"date\" name=\"enddate\" id=\"enddate\" value=\"");
      out.print( g.getEndDate() );
      out.write("\">\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<div id=\"filetext\">가격 :</div> &nbsp;<input type=\"text\" name=\"price\" id=\"price\" placeholder=\"가격을 입력하세요.\" value=\"");
      out.print( g.getPrice() );
      out.write("\">\r\n");
      out.write("\t\t\t\t\t<br><br><br>\r\n");
      out.write("\t\t\t\t\t<textarea name=\"content\" id=\"boardContent\" placeholder=\"내용을 입력하세요.\">");
      out.print( g.getExplain() );
      out.write("</textarea>\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t<br><br>\r\n");
      out.write("\t\t\t\t\t<button type=\"button\" id=\"list\" onclick=\"location.href='");
      out.print( context );
      out.write("/groupList.do'\">목록</button>\r\n");
      out.write("\t\t\t\t</form>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t</div>\r\n");
      ...
      out.write("\t\t\tvar title = document.getElementById(\"title\").value.replace(/ /g,\"\");\r\n");
      out.write("\t\t\tvar content = document.getElementById(\"boardContent\").value.replace(/ /g,\"\");\r\n");
      ...
      out.write("\t\t\t}\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\tif(!regexp.test(price)) {\r\n");
      out.write("\t        \talert(\"가격은 숫자만 입력하세요\");\r\n");
      out.write("\t            $('#price').val(price.replace(regexp,''));\r\n");
      out.write("\t            return;\r\n");
      out.write("\t        }\r\n");
      out.write("\t\t\tvar form = document.getElementById('form1');\r\n");
      out.write("\t\t\tif(boardUpdate(form)) {\r\n");
      ...
      out.write("<script src=\"");
      out.print( context );
      out.write("/resources/js/boardFile.js\"></script>\r\n");
      out.write("</html>");
