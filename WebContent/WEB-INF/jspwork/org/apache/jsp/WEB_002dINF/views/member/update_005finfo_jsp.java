 ...
 * Generated at: 2020-11-30 15:52:28 UTC
...
public final class update_005finfo_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	String context = request.getContextPath();
      ...
      out.write("<link rel=\"stylesheet\" type=\"text/css\" href=\"");
      out.print( context );
      out.write("/resources/css/update_info.css\">\r\n");
      out.write("\r\n");
      out.write("</head>\r\n");
      out.write("<body>\r\n");
 ...
 if(loginMember != null && loginMember.getRankCode() == 99) { 
      ...
      out.write("\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<button type=\"button\" id=\"updatePw\">비밀번호 변경</button>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<th>비밀번호 힌트</th>\r\n");
      out.write("\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div>비밀번호 찾기 힌트</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<br>\r\n");
      out.write("\t\t\t\t\t\t\t\t<script>\r\n");
      out.write("\t\t\t\t\t\t\t\t\tvar pwHint = document.getElementById(\"pwHint\");\r\n");
      out.write("\t\t\t\t\t\t\t\t\tfor(var i = 0; i < pwHint.children.length; i++) {\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tif(pwHint.children[i].value === '");
      out.print( memberInfo.getPwHint() );
      out.write("') {\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tpwHint.children[i].setAttribute('selected', '');\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\t\t</script>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div>비밀번호 찾기 답변</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input size=\"32\" name=\"pwAns\" id=\"pwAns\" required value=\"");
      out.print( memberInfo.getPwAns() );
      out.write("\"><br> <br>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"email\" name=\"email\" id=\"email\" required value=\"");
      ...
      out.write("\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"text\" name=\"nickname\" id=\"nickname\" required value=\"");
      out.print( memberInfo.getNickName() );
      out.write("\"> \r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"button\" id=\"checkNickname\" value=\"중복확인\">\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t</select> \r\n");
      out.write("\t\t\t\t\t\t\t\t\t- \r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"text\" maxlength=\"4\" size=\"4\" name=\"phone2\" id=\"phone2\" required value=\"");
      out.print( phone2 );
      out.write("\"> \r\n");
      out.write("\t\t\t\t\t\t\t\t\t- \r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"text\" maxlength=\"4\" size=\"4\" name=\"phone3\" id=\"phone3\" required value=\"");
      out.print( phone3 );
      out.write("\">\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t<script>\r\n");
      out.write("\t\t\t\t\t\t\t\t\tvar phone1 = document.getElementById(\"phone1\");\r\n");
      out.write("\t\t\t\t\t\t\t\t\tfor(var i = 0; i < phone1.children.length; i++) {\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tif(phone1.children[i].value === '");
      out.print( phone1 );
      out.write("') {\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tphone1.children[i].setAttribute('selected', '');\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\t\t</script>\r\n");
      out.write("\t\t\t\t\t\t\t</td>\r\n");
      ...
      out.write("<script src=\"");
      out.print( context );
      out.write("/resources/js/update_info.js\"></script>\r\n");
      out.write("</html>");
