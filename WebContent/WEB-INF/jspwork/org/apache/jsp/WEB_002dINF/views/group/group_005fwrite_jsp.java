 ...
 * Generated at: 2020-11-08 13:45:42 UTC
...
public final class group_005fwrite_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 if(loginMember != null && loginMember.getRankCode() == 99) { 
      ...
      out.write("\t\t\t\t<form action=\"groupWrite.do\" method=\"post\" encType=\"multipart/form-data\" id=\"groupWrite\">\r\n");
      out.write("\t\t\t\t\t<button id=\"obj\" type=\"button\" onclick=\"groupWrite();\">등록</button>\r\n");
      out.write("\t\t\t\t\t<br><br>\t\t\r\n");
      out.write("\t\t\t\t\t<input type=\"text\" id=\"title\" name=\"title\" placeholder=\"제목을 입력하세요.\">\r\n");
      out.write("\t\t\t\t\t<br><br>\r\n");
      out.write("\t\t\t\t\t<div id=\"fileField\">\r\n");
      out.write("\t\t\t\t\t\t<div id=\"filetext\">첨부파일  </div>\r\n");
      ...
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<div id=\"filetext\">가격 :</div> &nbsp;<input type=\"text\" name=\"price\" id=\"price\" placeholder=\"가격을 입력하세요.\">\r\n");
      out.write("\t\t\t\t\t<br><br><br>\r\n");
      out.write("\t\t\t\t\t<textarea id=\"boardContent\" name=\"content\" placeholder=\"내용을 입력하세요.\"></textarea>\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t<br><br>\r\n");
      ...
      out.write("\t\tvar mm = date.getMonth()+1 > 9 ? date.getMonth()+1 : '0' + date.getMonth()+1;\r\n");
      out.write("\t\tvar dd = date.getDate() > 9 ? date.getDate() : '0' + date.getDate();\r\n");
      out.write("\t\tvar sDate = $(\"#startdate\");\r\n");
      out.write("\t\tsDate.val(yyyy + \"-\" + mm + \"-\" + dd);\r\n");
      out.write("\t\tsDate.attr(\"min\", yyyy + \"-\" + mm + \"-\" + dd);\r\n");
      out.write("\t\tvar eDate = $(\"#enddate\");\r\n");
      out.write("\t\teDate.val(yyyy + \"-\" + mm + \"-\" + dd);\r\n");
      out.write("\t\teDate.attr(\"min\", yyyy + \"-\" + mm + \"-\" + dd);\r\n");
      out.write("\t\t\r\n");
      out.write("\t\tfunction groupWrite() {\r\n");
      ...
      out.write("                return;\r\n");
      out.write("            }\r\n");
      out.write("\t\t\tvar form = document.getElementById('groupWrite');\r\n");
