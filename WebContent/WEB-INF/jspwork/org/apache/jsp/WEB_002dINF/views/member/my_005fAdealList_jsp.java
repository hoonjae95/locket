 ...
 * Generated at: 2020-11-08 04:19:58 UTC
...
public final class my_005fAdealList_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 if(loginMember != null && loginMember.getRankCode() == 99) { 
      ...
      out.write("\t\t\t\t\t<form action=\"");
      out.print( context );
      out.write("/ADealCancel.do\" method=\"post\" onsubmit=\"return cancelDeal(this);\">\r\n");
      out.write("\t\t\t\t\t\t<input type =\"submit\" id =\"cancel\" value =\"취소하기\">\r\n");
      out.write("\t\t\t\t\t</form>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t<br><br><br>\r\n");
 ...
 if(AdealList.isEmpty()){ 
      out.write("\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<td colspan=\"5\">신청한 거래요청이 없습니다.</td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t");
 } else { 
      out.write("\r\n");
 ...
 for(Deal m : AdealList) { 
      ...
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<input type=\"checkbox\" name=\"selDeal\" onclick=\"selectOne();\" value='");
      ...
      out.write("/applyP.do?currentPage=1'\" align=\"center\"> &lt;&lt;</button>\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t<!-- 이전 페이지로 -->\r\n");
      out.write("\t\t\t\t\t<button onclick=\"location.href='");
      out.print( request.getContextPath() );
      out.write("/applyP.do?currentPage=");
 ...
 if(p == currentPage) { 
      ...
      out.write("\t\t\t\t\t\t\t\tselDeal[i].checked = true;\r\n");
      out.write("\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t} else{\r\n");
      out.write("\t\t\t\t\t\t\tfor(var i = 0; i < selDeal.length; i++){\r\n");
      ...
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\tfor(var i = 0; i < selDeal.length; i++){\r\n");
      out.write("\t\t\t\t\t\t\tif(selDeal[i].checked){\r\n");
      out.write("\t\t\t\t\t\t\t\tcount++;\r\n");
      out.write("\t\t\t\t\t\t\t} \r\n");
      out.write("\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\tif(count != selDeal.length){\r\n");
      ...
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t      \t$(function(){\r\n");
      out.write("\t\t\t      \t\t$('#dealTable td[name=td]').mouseenter(function(){\r\n");
      out.write("\t\t\t\t\t\t\t$(this).parent().css({'background':'darkgray', 'cursor':'pointer'});\r\n");
      out.write("\t\t\t\t\t\t}).mouseout(function(){\r\n");
      out.write("\t\t\t\t\t\t\t$(this).parent().css('background','#fffcf5');\r\n");
      ...
      out.write("\t\t\t      \t\r\n");
      out.write("\t\t\t      \t// 거절 기능\r\n");
      out.write("\t\t\t      \tfunction cancelDeal(form){\r\n");
      ...
      out.write("\t\t\t\t\t\t\talert('신청을 취소할 상품을 선택해 주세요.');\r\n");
      out.write("\t\t\t\t\t\t} else {\r\n");
      out.write("\t\t\t\t\t\t    if(confirm(\"정말 취소하시겠습니까?\")){\r\n");
