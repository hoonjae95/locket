		...
		<div id="content-area">
			...
			<div id="content">
				<div class="b_detail">
					...
					<img src="../resources/images/user.PNG" style="padding-left: 10px; witdh: 45px; height: 45px">
					...
					<div id="b_read_comments"> <!-- 여기에 댓글 입력될떄마다 추가 되야함 -->
						...
						<a href="#" id="report" style="font-size: 15px;">신고</a>
					</div>
					
					<!-- 여긴 댓글 쓰는 공간 -->
					<div id="b_write_comment" style="width: 850px; height: 200px;">
						<br>
						<font style="font-weight: bold; font-size: 17px;">브롤 꿈나무</font><span class="writer">작성자</span>
						...
						<button id="button1" style="background: rgb(223,72,0);">글 삭제</button>
