 ...
 */
@WebServlet("/applyP.do")
public class ADealListFormServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ADealListFormServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<Deal> AdealList = new ProductService().selectADeal(loginId, pi);

		String page = null;
		if (AdealList != null) {
			request.setAttribute("AdealList", AdealList);
			request.setAttribute("pi", pi);
			page = "WEB-INF/views/member/my_AdealList.jsp";
		} else {
