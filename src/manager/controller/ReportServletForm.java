...
/**
 * Servlet implementation class ReportServletForm
 */
@WebServlet("/managerreport.do")
public class ReportServletForm extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ReportServletForm() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    listCount = new AdminService().getReportCount();
		...
		ArrayList<Report> Rlist = new AdminService().selectReport(pi);
		String page = null;
