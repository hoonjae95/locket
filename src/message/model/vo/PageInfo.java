...
public class PageInfo {
	...
	public PageInfo(int currentPage, int listCount, int pageLimit, int boardLimit, int maxPage, int starPage,
			int endPage) {
		super();
	...
	public String toString() {
		return "PageInfo [currentPage=" + currentPage + ", listCount=" + listCount + ", pageLimit=" + pageLimit
				+ ", boardLimit=" + boardLimit + ", maxPage=" + maxPage + ", starPage=" + starPage + ", endPage="
				+ endPage + "]";
	}
