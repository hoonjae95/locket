 ...
 */
@WebServlet("/buy_list_a.do")
public class BuyList_AdminServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public BuyList_AdminServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		listCount = aService.getGroupListCount(gNum);
		...
		ArrayList<Apply> aList = aService.selectList_A(pi, gNum);

		String page = null;
		
		if(aList != null) {
			page = "WEB-INF/views/group/buy_list_admin.jsp";
